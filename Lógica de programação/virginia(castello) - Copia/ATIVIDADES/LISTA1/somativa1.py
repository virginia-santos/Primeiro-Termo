...
# pergunta2 = int(input("Digite seu nível atual:"))

# print("O jogador:" , pergunta1, "está no nível:" , pergunta2, "e pronto para partida!"vitoria balé)
...
# mesada = int(input("Digite a primeira variável"))
# total = (mesada * 4 )
# print("O valor que você terá no final do mês é:" , total)

# 3. Conversor de Internet: Peça um valor em Gigabytes (GB) e converta para
# Megabytes (MB) (multiplique por 1024).
# Giga = int(input("Digite a primeira váriavél em Gygabytes"))
# total = (Giga * 1024)
# print("O valor em Megabytes será:" , total)

# 4. Média de Notas: Peça as notas de Matemática e Português. Calcule e mostre a
# média final.
# notasmatemática = int(input("Digite as notas de matematica dos alunos"))
# notasportuguês = int(input("Digite as notas de portugues dos alunos"))
# total1 = (notasmatemática + notasportuguês)
# total2 = (total1 / 2)
# print("A média final é:" , total2)
...
# Seguidores = int(input("Qual a sua quantidade de sequidores que você possui atualmente?"))
# Seguidoreshoje = int(input("Quantos seguidores você recebeu hoje?"))
# total = (Seguidores + Seguidoreshoje)
# print("seu número atual de seguidores é:" , total)

# 6. Idade em Dias: Peça a idade do aluno e calcule aproximadamente quantos dias
# ele já viveu (idade * 365).
# idade = int(input("Quantos anos você tem?"))
# total = (idade * 365)
# print("A quantidade aproximada de dias que você viveu é:" , total)

# 7. Consumo de Lanche: Peça o preço do salgado e o preço do suco. Exiba o valor
# total da conta. 
# salgado = int(input("Qual é o valor do salgado?"))
# suco = int(input("Qual é o valor do suco?"))
# total = (salgado + suco)
# print("O valor final da conta foi:", total) 
...
# esse número, printando: "Curtida n° [i] recebida!".
# pergunta1 = int(input("Defina o limite de curtidas a partir de 0:"))
# for limite in range(pergunta1):
#      print(f"Curtida n° {limite} recebida!")
